...
class DistMatCreator(object):
    ...
    def get_dis_mat(self, locations):
        ...
        """
        # TODO: Need to write dynamic code that will use the MapOps to create the dist mat after we tested to google maps
        # TODO: If we use static DB then maybe we dont need the MapOps and just create the dist mat from the DB
        mat = [  # Just for testing
            [
